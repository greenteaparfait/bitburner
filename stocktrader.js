...
export async function main(ns) {
    ...
    function format(number) {
        ...
        const answer = ns.formatNumber(number, 3, 1000, false);;
    ...
    function formatReallyBigNumber(number) {
        ...
        // Use formatNumer for numbers it can format
    ...
    function sellIfOutsideThreshdold(stock) {
        ...
        if (position[0] > 0) {
            ...
            ns.print('      Position -> ' + ns.formatNumber(position[0], 3, 1000, false));
            ns.print('      Profit -> ' + ns.formatNumber(profit, 3, 1000, false));
