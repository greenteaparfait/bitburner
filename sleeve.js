...
const argsSchema = [
    ...
    ['crime-chance-threshold', 0.5], // Sleeves on crime will automatically start homicide once their chance of success exceeds this ratio
...
async function pickSleeveTask(ns, playerInfo, playerWorkInfo, i, sleeve, canTrain) {
    ...
    var crime = options.crime || (await calculateCrimeChance(ns, sleeve, "mug")) >= options['crime-chance-threshold'] ? 'mug' : 'mug';
